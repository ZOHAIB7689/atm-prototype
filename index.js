...
if (pinAnswer.pin === Pincode) {
    ...
    if (operations.operation === "withdraw") {
        ...
        console.log("operation succesful your remaining balance is", (withdrawal.withdraw -= myBalance));
    }
        ...
        if (fastcash.cash === "500") {
            console.log("operation succesfull your remaining balace is ", fastcash.cash - myBalance);
        }
        else if (fastcash === "1000") {
            console.log("operation succesfull your remaining balance is ", fastcash.cash - myBalance);
        }
